	...
	SwingKursNotenAnzeigenView(JFrame parent, KursNotenModel noten, 
		...
		groupLayout.setHorizontalGroup(groupLayout.createSequentialGroup()
			...
			.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
				...
				.addComponent(scrollPaneSchueler, 180, GroupLayout.PREFERRED_SIZE, Short.MAX_VALUE))
			.addPreferredGap(ComponentPlacement.UNRELATED)
			.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
				.addComponent(lblNoten)
				.addComponent(scrollPaneNoten, GroupLayout.PREFERRED_SIZE, 150, GroupLayout.PREFERRED_SIZE))
			.addPreferredGap(ComponentPlacement.UNRELATED)
